...
Gem::Specification.new do |s|
  ...
  s.date = "2015-09-30"
  s.description = "An implementation of an actor pool, based on the Celluloid concurrent object framework.".freeze
  s.email = ["tony.arcieri@gmail.com".freeze, "code@extremist.digital".freeze]
  s.homepage = "http://github.com/celluloid/celluloid-pool".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.7.7".freeze
  s.summary = "An implementation of an actor pool, based on the Celluloid concurrent object framework.".freeze
